...
import { pageAnimation, frameParentIvert, frameAnimationIvert, } from "../../utility/animation";
                ...
                <div className="recommend">
                  ...
                  <span className="recommended-label1">
                    <svg
                      ...
                      fill="none"
                    >
                      <g clipPath="url(#clip0_2528_2145)">
                        <path
          ...
          {name === "type" ? (
            <>
              <div className="r-type">
                ...
                <Link href="/contactus" className="r-option">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                  ...
                  <svg
                    ...
                    fill="none"
                  >
                    <g clipPath="url(#clip0_2524_1326)">
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
            ...
            <>
              {name === "responsive" ? (
                ...
                >
                  {data.map((option) => (
                    <div key={option.name} className={`extra-options`}>
                      <label
                        key={option.name}
            ...
            {!isSubmitted && (
              <>
                ...
                >
                  <div className="cal">
                    <div
                      className={`form-container ${showSummary ? "hidden1" : ""
                        }`}
                    >
                      {questions
                        .filter((question) =>
                        ...
                        <form className="order-form" onSubmit={sendEmail}>
                          ...
                          <button className="normal-btn primary">
                            ...
                            <svg
                              ...
                              xmlns="http://www.w3.org/2000/svg"
                            >
                              <g id="Send" clipPath="url(#clip0_2530_2660)">
                                <path
                                  id="Vector"
