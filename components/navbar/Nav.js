            ...
            <div className="container">
               ...
               <div className="wrapper">
                  ...
                  <ul className="social-icons">
                     ...
                     <li className="social"><Link href="https://www.upwork.com/agencies/websitevikreta/" target="_BLANK" rel="nonreferrer"><svg fill="currentColor" width="20px" height="20px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
