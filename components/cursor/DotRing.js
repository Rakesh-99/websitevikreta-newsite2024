      ...
      {isMouseInside && (
        <div className="mouse" style={{ left: `${x}px`, top: `${y}px` }}>
          <svg viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M19 39.5L24.5 29.5L35.5 32" stroke="#FFD600" strokeWidth="2" />
            <defs>
              <filter id="filter0_d" x="0.873779" y="0.205414" width="40.8471" height="40.7944" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
